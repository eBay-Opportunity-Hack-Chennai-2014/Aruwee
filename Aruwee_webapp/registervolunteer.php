...
if (x==null || x=="")
  ...
  var y=document.forms["regform"]["occupation"].value;
if (y==null || y=="")
  {
  alert("Occupation is needed");
  return false;
  }
...
if (e==null || e=="")
  ...
  var z=document.forms["regform"]["number"].value;
if (z==null || z=="")
  {
...
<div id="form">
<form  name="regform" method="post" action="regisproc1.php" onsubmit="return validate()">

<label>Enter your Name:</label><input id="box" type="text" name="name"/><br><br>
<label>Occupation:</label><input id="box" type="text" name="occupation" /><br><br>
<label>Phone Number:</label><input id="box" type="number" name="number"/><br><br>
<label>Enter age:</label><input id="box" type="number" name="age"/><br><br>
<label>Enter gender:</label><select id="box" name="sex">
<option value="Male">Male</option>
<option value="Female">Female</option>

</select><br><br>
<label>Address:</label><input id="box" type="text" name="address"/><br><br>

<label>Email:</label><input id="box" type="text" name="email"/><br><br>

<input id="sub" type="submit" name="submit" value="Add Volunteer to the List" />
</form></div>

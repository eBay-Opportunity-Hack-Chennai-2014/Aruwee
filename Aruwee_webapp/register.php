...
<form  name="regform" method="post" action="register_new.php" ">
<label>Enter user name:</label><input id="box" type="text" name="username"/><br><br>
<label>Enter Password:</label><input id="box" type="password" name="password"/><br><br>

...
if (x==null || x=="")
  ...
  var y=document.forms["regform"]["ieee"].value;
if (y==null || y=="")
  {
  alert("Membership number is needed");
  return false;
  }
  var e=document.forms["regform"]["mail"].value;
if (e==null || e=="")
  {
  alert("email should be entered");
  return false;
  }
  var z=document.forms["regform"]["year"].value;
if (z==null || z=="")
  {
  alert("Year must be selected");
  return false;
  }
   var z=document.forms["regform"]["dept"].value;
if (z==null || z=="")
  {
		...
		<div class="span2">
			<div id="top" class="sidebar-style sidebar-nav sidebar-nav-fixed">
				<div class="block logo">
					<!-- Logo --><a class="block-title" href="index.php">Techno Quiz</i></a>
				...
				<div class="baseline-border">
					<div class="baseline">
						<p>A technical aptitude event </p>
...
<form  name="regform" method="post" action="regisproc.php" onsubmit="return validate()">
<label>Enter your name:</label><input id="box" type="text" name="name"/><br><br>
<label>Enter IEEE member[YES/NO]:</label><input id="box" type="text" name="ieee"/><br><br>
<label>Enter email ID:</label><input id="box" type="text" name="mail" /><br><br>
<label>Enter Year:</label><select id="box" name="year">
<option value="1">1</option>
<option value="2">2</option>

...
<ul>
				...
				<div class="social">
					<a href="http://www.aruwe.org/index.html"><i class="icon-facebook"></i></a>
		...
		<div class="content">
			...
			<div class="span9">
				...
				<div class="span8 offset1 home-content home-title">
					<div class="home-marker"><i class="icon-globe icon-marker"></i></div>
		       <center> <div id="tab-menu">
    <ul>
            <li><a href="registerclient.php"><big>Register Client</a></li></li></br>

            <li><a href="registervolunteer.php">Add Volunteer</a></li></li></br>

        </ul>
 </div>
 <iframe width="80%" height="500px" src="img/ngo.jpg" name="iframe_a"></iframe></center>

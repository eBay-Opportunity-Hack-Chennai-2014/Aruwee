...
<div id="outer-wrap">
	...
	<ul>
							...
							<li><a href="donar.php" class="donar">Well wisher</li>
							<li><a href="contact.html" class="contact">Contact</a></li>

						</ul>						<a class="close-btn" id="nav-close-btn" href="#top"><i class="icon-remove icon-2x icon-border"></i></a>
					</div>	
				</nav>		
				<div class="social">
			...
			<div class="span9">
				...
				<div class="span9 offset1 home-content">
						<div class="project-slider">
						   ...
						   <center>
	<h3>Please Enter the Donar Details! </h3>
<!--
...
<div id="form">
<form  name="regform" method="post" action="regisdonar.php" onsubmit="return validate()">
<label>Enter Donar name:</label><input id="box" type="text" name="name"/><br><br>
<label>Enter age:</label><input id="box" type="number" name="age"/><br><br>

<label>Enter gender:</label><select id="box" name="gender">
<option value="Male ">Male</option>
<option value="Female">Female</option>
<option value="other">Other</option>
</select><br><br>

<label>Type of People whom you want to contribute:</label><select id="box" name="contribute">
<option value="children">Children</option>
<option value="women">Women</option>
<option value="old aged">Old Aged</option>
</select><br><br>

<label>Type of Organisation:</label><select id="box" name="organisation">
<option value="Indivual">Indivual</option>
<option value="Corporate">Corporate</option>
<option value="NGO">NGO</option>
<option value="other">other</option>
</select><br><br>
<label>Phone Number:</label><input id="box" type="int" name="number"/><br><br>
<label>Email:</label><input id="box" type="text" name="email"/><br><br>


<input id="sub" type="submit" name="submit" value="Add me to the Donar List" /><br><br>
